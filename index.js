...
/**
 * This sample shows how alexa can send an MQTT message to a standard MQTT broker.
...
function handleSessionEndRequest(callback) {
    ...
    const speechOutput = 'Thank you for trying the Light Switch sample. Have a nice day!';
...
function sendMqttCommand(commandToSend){
    var client  = mqtt.connect('mqtt://test.mosquitto.org');

    client.on('connect', function () {
        client.publish('/r1ckr/led', commandToSend);
        client.end();
    });
}
...
function controlLight(intent, session, callback) {
    ...
    if (lightCommandSlot) {
        ...
        repromptText = "I'm not sure what you wanted to do with the light. You can tell me " +
            'to turn on the light by saying, turn the light on';
    }
